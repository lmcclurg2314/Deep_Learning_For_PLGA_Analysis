...
import tensorflow as tf; tf.random.set_seed(111)
...
# 39 samples of training, 4 samples of validation, and 2 samples of testing
# Each sample has 10,000 cells

y = metaData.DOX_Ab.values # should be PLGA_DOX values
x = cytoData
...
with open("Result/dY.arr", "wb") as f:
    pickle.dump(dY, f)
...
graph.write_png("Result/decisionTree.png")
